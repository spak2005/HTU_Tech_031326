...
- **Improve** — Get actionable recommendations when gaps or inaccuracies are detected: DIY steps, AI-generated fixes, and GitHub and Slack/Teams integrations.
- **Launch** — Run AI readiness scans for new products, generate optimized content, and see results flow into the Track loop.

The app includes a **landing page**, **signup/onboarding** (company name, website URL), **track analysis dashboard** (AIO score and metrics), **improve** (health metrics, recommendations, agent-assisted fixes), and **launch** (product scans, code generation, PR workflow).
...
2. **Signup** (`/signup`) — Enter company name and website (e.g. “Dell”, “https://www.dell.com”). This drives the demo data shown later.
...
4. **Track Analysis** (`/analysis`) — Main **Track** experience: AIO Score hero, core health bars, trend chart, diagnostics, platform breakdown. Interpret this as “how the brand is doing across AI models.”
